 ...
 * target language (Bahasa Malaysia, Arabic, Korean).
 * 
 * @author Izzat Rahimi
 */
		...
		translate.createData();
				...
				try
				{
					...
					while (true) {
						...
						if(languageChoice == 1)
						{
							// parse the text for Bahasa Malaysia translation 
						...
						else if(languageChoice == 2)
						{
							...
							language = "Arabic";
							translated = translate.translateToArabic(text);
						}
						...
						else if(languageChoice == 3)
						{
							...
							language = "Korean";
							translated = translate.translateToKorean(text);
						}
						...
						System.out.println("Accepted connection from the " + " client. Total request = " + ++totalRequest);
