package tcpservertexttranslator;
...
public class TextTranslator {
	...
	/**
	 * This method retrieves BahasaMalaysia text for English-Bahasa Malaysia translation used.
	 * 
	 * @param text: Text input to be translated
	 * @return translated Bahasa Malaysia text
	 */
